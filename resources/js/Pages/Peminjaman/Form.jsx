...
export default function Form({ boardgames = [] }) {
  ...
  return (
    <div className="max-w-xl mx-auto p-4">
      ...
      <p className="text-sm text-slate-500 mb-6">Isi data berikut untuk mengajukan peminjaman boardgame</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="card bg-base-100 border border-base-300 shadow-sm">
          <div className="card-body p-5">
            <h2 className="card-title text-base mb-3">Data Peminjam</h2>
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">NIM</span>
              </label>
              <input
                type="text"
              ...
              />
              {errors.nim && <p className="text-error text-xs mt-1">{errors.nim}</p>}
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-100 border border-base-300 shadow-sm">
          <div className="card-body p-5">
            <h2 className="card-title text-base mb-3">Pilihan Board Game</h2>
            ...
            <div className="form-control mb-3">
              <label className="label">
                <span className="label-text font-medium">Cari board game</span>
              </label>
              <input
                type="text"
        ...
        <div className="card bg-base-100 border border-base-300 shadow-sm">
          <div className="card-body p-5">
            <h2 className="card-title text-base mb-3">Waktu Peminjaman</h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium">Tanggal pinjam</span>
                </label>
                <input
                  type="text"
                  className="input input-bordered w-full bg-base-200"
                  value={data.tanggal_pinjam ? new Date(data.tanggal_pinjam + "T00:00:00").toLocaleDateString("en-GB", { day: "2-digit", month: "long", year: "2-digit" }) : ""}
                  disabled
                />
              </div>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium">Jam pinjam</span>
                </label>
                <input
                  type="text"
                  ...
                  disabled
                />
                {errors.jam_pinjam && <p className="text-error text-xs mt-1">{errors.jam_pinjam}</p>}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3 pt-1">
          ...
          <button type="button" className="btn btn-ghost" onClick={() => reset()} disabled={processing}>
            Reset
          </button>
        </div>
      </form>
