            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" value={data.link_foto} onChange={(e) => setData('link_foto', e.target.value)} className="input input-bordered w-full input-sm" placeholder="URL foto (opsional)" />
