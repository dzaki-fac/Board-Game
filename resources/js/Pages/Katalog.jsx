...
function KartuGame({ game, tersedia }) {
    ...
    const Wrapper = tersedia ? Link : "div";
    const propsWrapper = tersedia ? { href: `/katalog/${game.id}` } : {};
    ...
    return (
        <Wrapper
            ...
            className={`group h-full flex flex-col rounded-2xl border transition-all duration-300 overflow-hidden ${
                tersedia
                    ? "bg-white border-slate-100 shadow-sm hover:shadow-lg hover:-translate-y-0.5 cursor-pointer"
            ...
            <div className="p-4 flex flex-col flex-1">
                ...
                <div className="mt-2">
                    ...
                    {tersedia ? (
                        ...
                        <span className="block w-full rounded-full py-2 text-sm font-semibold bg-slate-200 text-slate-400 text-center">
                            {t.dipinjam}
                        </span>
                    )}
                </div>
...
function AnnouncementCarousel({ games }) {
    ...
    const infoSlides = useMemo(() => ([
        { judul: t.tataCaraJudul, aksen: WARNA.emas, ikon: "centang", poin: t.tataCaraPoin, ilustrasi: "tataCara" },
...
function IsiKatalog({ games, bahasa, setBahasa }) {
    ...
    return (
        <div className="min-h-screen bg-[#FAF7F2] text-[15px]">
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-10 pt-5 pb-10">
